      ...
      <div>
        <footer style={{ position: "absolute", bottom: "0", width: "100%" }}>
          <div className="bg-slate-200 pl-64 py-5">
            <p className="font-semibold mb-5">ACKNOWLEDGEMENT OF COUNTRY</p>
            <p className="pr-[25%]">
              We acknowledge the Traditional Custodians of NSW, and their
              continued connection to land, water and culture. We pay our
          ...
          <div className="bg-gray-800 pl-[10.5%] pr-[20%] py-5 text-white text-[14.5px] font-semibold">
            <div style={{ display: "flex", justifyContent: "space-evenly" }}>
              ...
              <a href="https://www.service.nsw.gov.au/privacy-statement">
                Privacy
              </a>
              <a href="https://www.service.nsw.gov.au/terms-use">
                Terms of use
              </a>
