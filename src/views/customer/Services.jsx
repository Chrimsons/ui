    ...
    <body>
      ...
      <section>
        {licences.map((l) => (
          <div
            key={l._id}
            className="tile ml-72 text-2xl font-semibold text-center"
          >
            <div className="licence-box">
              <div className="border-[3px] border-yellow-300 border-dotted mx-5 my-10">
            ...
            <div className="total-remaining-hours">
              ...
              <div className="mt-10">
                Remaining Hours: <br />
                <div className="border-[3px] mt-3 mx-52 border-dotted border-black text-center">
                  {120 - l.total.hours}
                </div>
              </div>
            </div>
            ...
            <div className="progress-bar">
              <div className="flex flex-row justify-center mt-10">
                <div className="day-progress text-yellow-500">
                  Day hours: <br />
                ...
                <div className="night-progress ml-5 text-blue-500">
            ...
            <div className="buttons">
              <button
                className="rounded-full mt-10 px-10 py-3 text-center hover:bg-blue-500"
